...
//	    this.images = mockImages
	  ...
	  watch: {
		  ...
		  isFullScreen() {
			  !this.isFullScreen && this.$api.reportByInfoc('liebao_urlchoose_detail:366 action:byte name:string url:string ver:byte action_time:string number1:int number2:int', {
				  action: 21,
				  name: this.category.id + '',
				  url: '',
				  action_time: getOperationFullTime(new Date()),
	  ...
	  methods: {
		  ...
		  likeSite(event) {
			  ...
			  site.liked && this.$api.reportByInfoc('liebao_urlchoose_detail:366 action:byte name:string url:string ver:byte action_time:string number1:int number2:int', {
				  action: 3,
				  name: this.category.id + '',
				  url: site.url,
				  action_time: getOperationFullTime(new Date()),
...
<style lang="stylus" rel="stylesheet/stylus">
  ...
  .lightbox
    ...
    .close
      ...
      background url("../../../../../assets/img/collection/close.png") no-repeat
      width 48px
      height 48px
      &:hover
